...
$APPLICATION->SetPageProperty('TITLE', 'О себе ');
$APPLICATION->SetPageProperty("keywords", "о себе, Oleg, we coders");
?>
...
<section class="who-area-are pad-90" id="about_us">
    <div class="container">
        <h2 class="title-1">Немного о себе</h2>
        <div class="row">
            <div class="col-md-7">
                <div class="who-we">
